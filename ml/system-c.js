...
app.get('/flight_delay', function(req,res) {
    let options = {
        ...
        pythonOptions: ['-u'], 
          scriptPath: './ml', 
        args: [req.query.dep_airport, req.query.arr_airport, req.query.month, req.query.day_date, req.query.day_week, req.query.hour, req.query.dep_delay, req.query.duration] 
    };
